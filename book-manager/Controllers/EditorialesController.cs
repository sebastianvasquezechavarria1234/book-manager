...
namespace book_manager.Controllers
{
    ...
    {
        private readonly CrudSebastianVasquezContext _context;

        public EditorialesController(CrudSebastianVasquezContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Nit,Nombres,Telefono,Direccion,Email,SitioWeb")] Editoriale editoriale)
        {
        ...
        private bool EditorialeExists(string id)
        {
