...
namespace ExamenMVC.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(CrudSebastianVasquezContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Nombre,Apellido,Email,Nacionalidad")] Autore autore)
        {
